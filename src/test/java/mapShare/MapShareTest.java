...
public class MapShareTest {
    ...
    public void mapShare1() {
        Map<String, String> map = new HashMap<>(Map.of("a", "aaa", "b", "bbb", "c", "ccc"));
    ...
    public void mapShare2() {
        Map<String, String> map = new HashMap<>(Map.of("b", "xzy", "c", "ccc"));
    ...
    public void mapShare3() {
        Map<String, String> map = new HashMap<>(Map.of("a", "aaa", "c", "meh", "d", "hi"));
